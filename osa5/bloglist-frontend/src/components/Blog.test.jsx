...
describe('Blog component', () => {
  test('renders title and author, but not url or likes by default', () => {
    ...
    const titleElement = screen.getByText((content, element) => element.tagName.toLowerCase() === 'div' && content.includes('testTitle'))
    const authorElement = screen.getByText((content, element) => element.tagName.toLowerCase() === 'div' && content.includes('testAuthor'))
